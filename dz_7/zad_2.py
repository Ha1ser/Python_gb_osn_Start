...
if len(phrases) <= 1:
    ...
    syllable_counts = [sum(1 for letter in phrase if letter in 'аеёиоуыэюя') for phrase in phrases]
...
# 2 way
# st = 'со-лнце-гре-ет ве-снооой'.split()                                                               
# if len(st) > 1:
#     ls = []
#     for i in st:
#         ls.append(len([x for x in i if x in 'аеёиоуыюя']))
#     if len(set(ls)) == 1: 
#         print('Парам пам-пам')
#     else:
#         print('Пам парам') 
